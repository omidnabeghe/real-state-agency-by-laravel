...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> Create Post</li>
    </ol>
  </nav>
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" value="{{ old('published_at') }}" name="published_at"  id="published_at" class="form-control ">
                            </div>
                                @error('published_at')
                                <span class=" text-danger" role="alert">
                                    <strong>{{ $message }}</strong></span>
