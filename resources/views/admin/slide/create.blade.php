                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('url') }}" name="url" type="text" id="url" class="form-control" placeholder="link ...">
                                    @error('url')
                                    <span class=" text-danger" role="alert">
                                        <strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('address') }}" name="address" type="text" id="address" class="form-control" placeholder="address ...">
                                    @error('address')
                                    <span class=" text-danger" role="alert">
                                        <strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('amount') }}" name="amount" type="text" id="amount" class="form-control" placeholder="amount ...">
                                    @error('amount')
                                    <span class=" text-danger" role="alert">
                                        <strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="body" rows="5" name="body" placeholder="text ...">{{ old('body') }}</textarea>
                                </section>
                                @error('body')
                                <span class=" text-danger" role="alert">
                                    <strong>{{ $message }}</strong></span>
